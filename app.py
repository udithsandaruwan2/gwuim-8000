...
def create_image():
    ...
    image = Image.open(r"C:\workspace\gwuim\app_icon.ico")
    return image
...
os.chdir(r"C:\workspace\gwuim")

# Activate virtual environment
subprocess.Popen(r'venv\Scripts\activate.bat', shell=True, creationflags=subprocess.CREATE_NO_WINDOW)

# Change to the correct directory for running the Django server
